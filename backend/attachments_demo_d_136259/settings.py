"""
Django settings for attachments_demo_d_136259 project.
...
ROOT_URLCONF = 'attachments_demo_d_136259.urls'
...
WSGI_APPLICATION = 'attachments_demo_d_136259.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "attachments-demo Support <support@attachments-demo-d-136259.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "attachments_demo_d_136259 API",
    "DESCRIPTION": "API documentation for attachments_demo_d_136259 App",
    "VERSION": "v1",
}
